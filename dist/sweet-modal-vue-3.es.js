...
const _hoisted_6 = /* @__PURE__ */ createElementVNode("span", { class: "sweet-modal-x-mark" }, [
...
const _hoisted_9 = /* @__PURE__ */ createElementVNode("span", { class: "sweet-modal-body" }, null, -1);
const _hoisted_10 = /* @__PURE__ */ createElementVNode("span", { class: "sweet-modal-dot" }, null, -1);
const _hoisted_11 = [
  _hoisted_9,
  _hoisted_10
];
...
const _hoisted_14 = /* @__PURE__ */ createElementVNode("span", { class: "sweet-modal-line sweet-modal-tip" }, null, -1);
const _hoisted_15 = /* @__PURE__ */ createElementVNode("span", { class: "sweet-modal-line sweet-modal-long" }, null, -1);
const _hoisted_16 = /* @__PURE__ */ createElementVNode("div", { class: "sweet-modal-placeholder" }, null, -1);
const _hoisted_17 = /* @__PURE__ */ createElementVNode("div", { class: "sweet-modal-fix" }, null, -1);
const _hoisted_18 = [
  _hoisted_14,
  _hoisted_15,
  _hoisted_16,
  ...
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", _hoisted_4, [
        $props.icon == "error" ? (openBlock(), createElementBlock("div", _hoisted_5, _hoisted_7, 512)) : createCommentVNode("", true),
        $props.icon == "warning" ? (openBlock(), createElementBlock("div", _hoisted_8, _hoisted_11, 512)) : createCommentVNode("", true),
        $props.icon == "info" ? (openBlock(), createElementBlock("div", _hoisted_12, null, 512)) : createCommentVNode("", true),
        $props.icon == "success" ? (openBlock(), createElementBlock("div", _hoisted_13, _hoisted_18, 512)) : createCommentVNode("", true),
        _ctx.$slots.default ? (openBlock(), createElementBlock("div", _hoisted_19, [
          renderSlot(_ctx.$slots, "default")
        ])) : createCommentVNode("", true)
      ], 512),
      _ctx.$slots.button ? (openBlock(), createElementBlock("div", _hoisted_20, [
...
var SweetModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
const _sfc_main = {
  props: {
    title: {
      type: String,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass(["sweet-modal-tab", { active: $data.active }])
  }, [
    renderSlot(_ctx.$slots, "default")
  ], 2);
}
var SweetModalTab = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
var index = {
  install(app) {
